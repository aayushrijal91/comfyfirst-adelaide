					...
					<div class="row g-0">
						...
						<div class="col-xl-8 order-1 order-xl-2">
							<div class="card-body p-xxl-5 p-4">
								...
								<p>Parking lots that are covered or in basements must have enough ventilation. These areas may generate an unhealthy environment because of exhaust emissions and inadequate natural ventilation. Building departments require that business properties have enough ventilation. Well-functioning car park supply systems help maintain the structure's health and warns owners of potentially dangerous alterations.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4">Various Car Park Supply Systems </p>
							<hr class="hr-h hr-white ">

							<p>We understand this is specialised equipment, and our experts will make sure you have the right systems in place, including CO2 Detectors. These sensors help check whether carbon dioxide levels in a particular area are within acceptable safety limits. If CO2 levels get too high, it could pose a serious health risk to anyone who uses that parking lot.</p>

							<p>There are various a number of devices in the marketplace, each with its own set of benefits and drawbacks. Our experts will take into account all of your requirements and propose a solution that will ensure adequate safety levels in your parking lot. The following are the most commonly used sensor types:</p>
							<ul>
				...
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							...
							<p>Our professionals are well versed in a variety of sensor types and brands. Only gadgets with a proven track record will be proposed and installed. If you want systems that will last for a long time on your property, you should choose high-quality products and the finest installations. We undertake repairs, maintenance, and replacement of all sorts of sensor units as a dependable and professional firm providing top quality solutions to commercial clients.</p>
