...
$title = 'Make-Up Air Supply Ventilator';
...
$banner = 'Make-Up Air Supply Ventilator';
							...
							<div class="card-body p-xxl-5 p-4">
								<div class="row">
									<div class="col-xxl-12">
										<p class=" text-dark display-2 line-height-1 fw-bold">Make-Up Air Supply Ventilator</p>
									</div>
								</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-xxl-7">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4">What is a Makeup Air Supply Ventilator in <?= $global_city ?>?</p>
		...
		<div class="row justify-content-center">
			<div class="col-xxl-9">
				<div class="row align-items-center">
					<div class="col-xxl-6">
						<div class="py-3 py-xxl-5">
							<p class="display-2 fw-bold line-height-1 mb-4 me-xxl-n5">High Grade Make-up Air Supply Ventilator Installation</p>
